# 【十字军之王3】卡纳利塔斯（Carnalitas）框架环境自助安装清单

## 前言

- **版本信息**：
    - **当前清单更新时间**：*2024/04/27* *23:50*
    - **游戏版本**：***scythe***（***1.12.4***）
...
- [Character-Graphics-Series](#Character-Graphics-Series)
    ...
    - [CBO-Unofficial-Fix](#CBO-Unofficial-Fix)
    - [CFP-CBO-Compatibility](#CFP-CBO-Compatibility)
    - [CFP+EPE-CBO-Compatibility](#CFP+EPE-CBO-Compatibility)
- [Better-Barbershop-Series](#Better-Barbershop-Series)
    ...
    - [Fix-Fullscreen-Barbershop-for-EPE](#Fix-Fullscreen-Barbershop-for-EPE)
- [Carnalitas-Additional-Series](#Carnalitas-Additional-Series)
...
- 链接
    - [LoversLab](https://www.loverslab.com/files/file/16683-character-body-overhaul/)
    - **05**.[Mega](https://mega.nz/file/ZMMRTBAa#D1PA7joj9JNJ5MvKDO-7GqU3hD18Hp_kwnuIoiSARrM)

#### Character Beautification
- 链接
    - **06**.[Steam](https://steamcommunity.com/sharedfiles/filedetails/?id=2222302033)

#### CBO Unofficial Fix
- **文件**
    - **07**.CBO 1.12.1 Unofficial fix 1.8.zip
        - 98.9 MB
        - 2024/03/31
...
- **文件**
    - 5lEkEL4T
        - **08**.CFP CBO Patch 1.6.zip
            - 174.4 MB
            - 2024/03/31

- 链接
    - [LoversLab](https://www.loverslab.com/files/file/32269-cfp-cbo-patch/)
    - **08**.[Mega](https://mega.nz/file/5lEkEL4T#S6Jmdoamux6sR6upRoDHCiLtzY7N3MH6rnVU-jY8NaE)

#### CFP+EPE CBO Compatibility
- **文件**
    - **09**.EPE CBO Patch 3.2.zip
        - 75.93 MB
        - 2024/03/23
    - **10**.CFP + EPE Compatibility Patch（[Steam](https://steamcommunity.com/sharedfiles/filedetails/?id=2996881191)）
    - **11**.CFP+EPE CBO Patch 3.2.zip
        - 72.25 kB
        - 2024/03/23

- 链接
    - [LoversLab](https://www.loverslab.com/files/file/31846-epe-roa-mb-cbo-patch/)
...
- **文件**
    - **13**.Better Barbershop Beta CBO Extension 1.0.zip
        - 33.14 kB
        - 2024/03/10
...
#### Fix Fullscreen Barbershop for EPE
- 链接
    - **14**.[Steam](https://steamcommunity.com/sharedfiles/filedetails/?id=2785402553)

### Carnalitas Additional Series

#### Carnalitas Arousal Framework
- **文件**
    - **15**.Carnalitas Arousal Framework 1.1.zip
        - 243.16 kB
        - 2024/03/17

- 链接
    - [LoversLab](https://www.loverslab.com/files/file/15277-carnalitas-arousal-framework/)

#### Carnalitas Love Reimagined
- **文件**
    - **16**.carnalitas_love_reimagined-0.4.2.zip
        - 1.04 MB
        - 2024/03/19
...
- **文件**
    - **17**.carnalitas_slavery_reimagined-0.20.0.zip
        - 906.79 kB
        - 2024/03/23
